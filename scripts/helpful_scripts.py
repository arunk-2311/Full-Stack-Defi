...
def deploy_mocks(decimals=DECIMALS, initial_value=INITIAL_VALUE):
    ...
    print(
        f"Deployed WETH to {network.show_active()} at address {weth_token.address}")

    print("Deploying mock DAI...")
    fau_token = MockDAI.deploy({"from": account})
    print(
        f"Deployed DAI to {network.show_active()} at address {fau_token.address}")
